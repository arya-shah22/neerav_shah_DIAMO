...
export interface IStockPacket {
  ...
  fluorescenceIntensity: string | null;
  fluorescenceColor: string | null;
  rapPricePerCarat: number | null;
  ...
  girdleMin: string | null;
  girdleMax: string | null;
  girdleCondition: string | null;
  culetSize: string | null;
  culetCondition: string | null;
  heartsAndArrows: string | null;
  ...
  tinge: string | null;
  lustre: string | null;
  tableInclusion: string | null;
  sideInclusion: string | null;
  tableOpen: string | null;
  crownOpen: string | null;
  girdleOpen: string | null;
  origin: string | null;
  certificateUrl: string | null;
  webUrl: string | null;
  inscription: string | null;
  keyToSymbols: string | null;
  diamondComment: string | null;
  ...
  brand?: string | null;
  sellerSpec?: string | null;
  pairStockNumber?: string | null;
  isPairSeparable?: string | null;
  parcelStones?: string | null;
  reportFilename?: string | null;
  reportIssueDate?: string | null;
  labLocation?: string | null;
  certComment?: string | null;
  memberComment?: string | null;
  allowRaplinkFeed?: string | null;
  sarineLoupe?: string | null;
  reportType?: string | null;
  diamondType?: string | null;
  blackInclusion?: string | null;
  whiteInclusion?: string | null;
  openInclusion?: string | null;
